...
public class UniversitySemesterMapperImpl implements UniversitySemesterMapper {
    ...
    @Override
    public List<UniversitySemesterDTO> toUniversitySemesterDTOs(List<UniversitySemester> universitySemesters) {
        if ( universitySemesters == null ) {
            return null;
        }

        List<UniversitySemesterDTO> list = new ArrayList<UniversitySemesterDTO>( universitySemesters.size() );
        for ( UniversitySemester universitySemester : universitySemesters ) {
            list.add( toUniversitySemesterDTO( universitySemester ) );
        }
